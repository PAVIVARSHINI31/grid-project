...
`,
  ...
  p = ({ col: e, index: t, updateTitle: n, updateColor: r, moveColumn: i }) =>
    (0, f.jsxs)(`div`, {
      style: { backgroundColor: e.color, padding: `10px` },
      children: [
        ...
        (0, f.jsx)(`input`, {
          ...
          onChange: (e) => i(t, Number(e.target.value)),
        }),
      ],
    }),
  m = ({ columns: e, updateTitle: t, updateColor: n, moveColumn: r }) =>
    (0, f.jsx)(`div`, {
      style: {
        display: `grid`,
      ...
      children: e.map((e, i) =>
        (0, f.jsx)(
          p,
          { col: e, index: i, updateTitle: t, updateColor: n, moveColumn: r },
          e.id,
        ),
      ),
    }),
  h = ({ columns: e, updateColumns: t }) =>
    (0, f.jsxs)(`div`, {
      children: [
        (0, f.jsx)(`input`, {
          type: `number`,
        ...
        (0, f.jsx)(`button`, { onClick: () => t(e.length + 1), children: `+` }),
        (0, f.jsx)(`button`, { onClick: () => t(e.length - 1), children: `-` }),
        (0, f.jsx)(`br`, {}),
        (0, f.jsx)(`br`, {}),
      ],
    ...
    children: [
      ...
      (0, f.jsx)(h, {
        ...
        updateColumns: (n) => {
          ...
          let r = [...e];
          (n > r.length
            ? r.push({ id: Date.now(), title: `Column ${n}`, color: `#ccc` })
            : r.pop(),
            t(r));
        },
      }),
      (0, f.jsx)(m, {
        columns: e,
        updateTitle: (n, r) => {
          t(e.map((e) => (e.id === n ? { ...e, title: r } : e)));
        },
        updateColor: (n, r) => {
          t(e.map((e) => (e.id === n ? { ...e, color: r } : e)));
        },
        moveColumn: (n, r) => {
